...
structure:
- Data Pipeline  : Auto-load CSV terbaru, feature engineering
- ML Models      : LR, DT, RF, GB, XGB, LightGBM, SVM
- RL Model       : PPO (Stable-Baselines3 + Gymnasium)
- Risk Management: Stop-loss, position sizing, drawdown
- Backtest       : Simulasi P&L, metrics, comparison chart
- Output         : Charts (prediction, comparison, confusion), CSV

"ill keep evolving till i die" ahh machine
"""
#evolve my jupyter and python script to make em smarter
#this is ai slop btw
import warnings
